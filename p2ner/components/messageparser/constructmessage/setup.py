...
__component_name__ = "ConstructMessage"
...
__license__ = """Licensed under the Apache License, Version 2.0 (the "License");
   ...
   See the License for the specific language governing permissions and
   limitations under the License."""
__description__ = "P2ner Construct messaging component"
...
setup(
    ...
    packages=[__component_name__.lower(), __component_name__.lower()+".constructs"],
    package_data = __pkg_data__,

    entry_points="""
    [p2ner.components.messageparser]
    %s = %s:%s
