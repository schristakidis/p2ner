...
class Deploy():
    ...
    def setPathVariables(self):
        ...
        if not self.curr_dir.endswith('GUI'):
            self.close("The script must be run from 'p2ner/win32'")
...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">\n\
    ...
    def get_datafiles(self):
        ...
        for f in ["interface.glade", "settings.glade", "player2.glade"]:
            ret.append((os.path.join("..", "p2ner", "interfaces", "control", "gtkgui", f), f))
        return ret
    ...
    def runCx_FreezeSetup(self):
        ...
        #packages = ['p2nerGUI'] + find_packages('..'),
        icon = None
        )
        
        pack = ['p2nerGUI'] + find_packages('..')
        pack.remove("p2nerWebUIServer")
        pack.remove("p2wsgiServer")
        setup(
            name = 'P2NER',
            ...
            options = {"build_exe": {
                            ...
                            "packages": pack,
                            "includes": ['gtk', 'gst', 'cairo', 'pangocairo', 'pango', 'atk', 'gobject',
                                        'gio', 'zlib', 'matplotlib.backends.backend_gtkagg'], 
                            ...
                            "excludes": ["pywin.debugger", "pywin.debugger.dbgcon","bz2", 
                                        ...
                                        "doctest","macpath","pdb","ssl","win32ui",
            ...
            executables = [P2NER_Target],
            data_files = self.get_datafiles(),
        )
...
def main():
    ...
    parser.add_option("-k", "--gtk-path", action="store",
            dest="gtkPath",default="C:\\Program Files\\GTK2-Runtime\\", type="string",
            help="GTK+ installation path")
    parser.add_option("-c", "--crt-path", action="store",
            dest="crtPath",default="c:\\Windows\\winsxs\\x86_microsoft.vc90.crt_1fc8b3b9a1e18e3b_9.0.30729.4926_none_508ed732bcbc0e5a\\", type="string",
