...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">\n\
    ...
    def get_datafiles(self):
        ...
        for f in ["addServer.glade", 'advancedFile.glade',"calendar.glade", "clientall.glade",'converter.glade', "producer.glade", "remoteFileChooser.glade", "serversGui.glade", "settingsGui.glade"]:
        ...
        for f in ['generic.glade','optComponents.glade','optGeneral.glade','options.glade','optServers.glade','optUPNP.glade','optView.glade']:
    ...
    def runCx_FreezeSetup(self):
        ...
        setup(
            ...
            options = {"build_exe": {
                            ...
                            "packages": find_packages(),
                            "includes": ['gtk', 'cairo', 'pangocairo', 'pango', 'atk', 'gobject',
                                        'gio', 'zlib','wmi'], #'gst', 'pygst'
                            ...
                            "excludes": ["pywin.debugger", "pywin.debugger.dbgcon","bz2", 
                                        ...
                                        "doctest","macpath","ssl","win32ui","pdb","construct.debug",
...
def main():
    ...
    parser.add_option("-c", "--crt-path", action="store",
            dest="crtPath",default="c:\\Windows\\winsxs\\x86_microsoft.vc90.crt_1fc8b3b9a1e18e3b_9.0.30729.1_none_e163563597edeada\\", type="string",
