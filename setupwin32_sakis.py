...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">\n\
    ...
    def get_datafiles(self):
        ...
        for f in ["addServer.glade",  'advancedFile.glade',"calendar.glade", "clientall.glade",'converter.glade','measureupload.glade','networkGui.glade','plot.glade', "producer.glade", "remoteFileChooser.glade", "serversGui.glade", "settingsGui.glade",'stats.glade']:
        ...
        ret.append((os.path.join("p2ner", "components", "plugin", "remoteproducerui",'remoteproducerui','connect2.glade'), 'connect2.glade'))
        ret.append((os.path.join("p2ner", "components", "plugin", "remoteproducerui",'remoteproducerui','viewer.glade'), 'viewer.glade'))
        for f in ['generic.glade','optComponents.glade','optGeneral.glade','options.glade','optRemote.glade','optServers.glade','optUPNP.glade','optView.glade','dvbFrame.glade']:
            ret.append((os.path.join("p2ner", "components", "ui", "gtkgui", "gtkgui",'options', f), f))
        ...
        setup(
            ...
            options = {"build_exe": {
                            ...
                            "includes": ['gtk', 'cairo', 'pangocairo', 'pango', 'atk', 'gobject','logging.handlers',
                                        'gio', 'zlib','wmi','matplotlib','matplotlib.backends.backend_gtkagg','code','pylab','xml.dom.minidom','twisted.web.client'], #'gst', 'pygst'
            ...
            executables = [P2NER_Target, P2NER_SERVER,P2NER_GUI],#P2NER_INPUT
        )
